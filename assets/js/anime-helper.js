{
  const e = "undefined" != typeof jQuery ? jQuery : null,
    ...
    l = async (t, n, r) => {
      ...
      if (n.onscroll) {
        const e =
          "boolean" == typeof n.onscroll ? { triggerElement: t } : n.onscroll;
        ...
        const s = e || {},
          l = s.triggerElement
            ? "string" == typeof s.triggerElement
              ? document.querySelector(s.triggerElement)
              : s.triggerElement
            : t;
      ...
      if (
        ...
        const e = "number" == typeof n.onview ? n.onview : 0,
          r = () => {
            window.innerHeight > t.getBoundingClientRect().top - e &&
    ...
    c = async (t) => {
      ...
      let a;
      if ((Object.assign(n, { targets: i }), n.timeline)) {
        const e = n.timeline;
        delete n.timeline,
          g[e] ||
            (d[e] ||
  ...
  Object.assign(window, { defineAnimeTimelineHelper: p });
  const u = async (t) => {
